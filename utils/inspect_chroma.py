...
'''
        ...
        subprocess.run(["docker", "cp", "/tmp/inspect_chroma.py", f"{container_id}:/tmp/"])
        ...
        console.print(Panel(f"[bold green]Found {data['count']} documents in Docker Chroma database[/]"))
