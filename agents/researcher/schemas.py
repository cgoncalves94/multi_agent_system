...
class SearchQueries(BaseModel):
    ...
    web_query: str = Field(description="Query optimized for web search, focused on recent and broad information")
    wiki_query: str = Field(description="Query optimized for Wikipedia, focused on historical and factual information") 