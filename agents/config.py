...
class EnvConfig(BaseModel):
    ...
    langchain_project_name: str = Field("multi_agent_system", description="LangChain project name")
    ...
    def ensure_dirs(self) -> None:
        ...
        dirs = [
            self.data_dir,
            self.chroma_path,
            os.path.dirname(self.state_db_path)
        ]
    ...
    def load_env(cls) -> "EnvConfig":
        ...
        config = cls(
            ...
            chroma_path=os.getenv("CHROMA_PATH", "/deps/multi_agent_system/data/chroma_db"),
